...
export type U8 = bigint & { _brand: 'U8' };
export type U16 = bigint & { _brand: 'U16' };
export type U32 = bigint & { _brand: 'U32' };
export type U64 = bigint & { _brand: 'U64' };
export type U128 = bigint & { _brand: 'U128' };
...
export type I8 = bigint & { _brand: 'I8' };
export type I16 = bigint & { _brand: 'I16' };
export type I32 = bigint & { _brand: 'I32' };
export type I64 = bigint & { _brand: 'I64' };
export type I128 = bigint & { _brand: 'I128' };

export type I8LeBytes = Bytes & { _brand: 'I8LeBytes' };
export type I16LeBytes = Bytes & { _brand: 'I16LeBytes' };
export type I32LeBytes = Bytes & { _brand: 'I32LeBytes' };
export type I64LeBytes = Bytes & { _brand: 'I64LeBytes' };
export type I128LeBytes = Bytes & { _brand: 'I128LeBytes' };
